...
NFSIP=`gcloud beta filestore instances describe nfs-server --project=bootcamp-2018-k8s-demo --location=us-central1-c --format=json | jq -r '.networks[0].ipAddresses[0]'`
echo $NFSIP
